...
export class EntrepriseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.entrepriseService
      ...
      .subscribe(
        (res: HttpResponse<IEntreprise[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IEntreprise[] | null, headers: HttpHeaders, page: number): void {

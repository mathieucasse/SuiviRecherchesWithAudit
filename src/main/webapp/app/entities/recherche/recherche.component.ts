...
export class RechercheComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.rechercheService
      ...
      .subscribe(
        (res: HttpResponse<IRecherche[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IRecherche[] | null, headers: HttpHeaders, page: number): void {

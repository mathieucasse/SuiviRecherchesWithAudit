...
import ch.matfly.suivirecherches.domain.AbstractAuditingEntity;
import ch.matfly.suivirecherches.domain.EntityAuditEvent;
import ch.matfly.suivirecherches.repository.EntityAuditEventRepository;
